...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Authentication is done via Laravel Sanctum. Include the token in the Authorization header as a Bearer token: `Authorization: Bearer {token}`',
    ],
    ...
    'strategies' => [
        ...
        'responses' => [
            ...
            [
                ...
                [
                    // Enable response calls for all methods to generate real examples
