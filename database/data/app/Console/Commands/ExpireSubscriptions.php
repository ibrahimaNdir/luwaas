...
class ExpireSubscriptions extends Command
{
    ...
    {
        $expired = Proprietaire::where('subscription_status', 'free_trial')
        ...
        foreach ($expired as $proprietaire) {
            ...
            try {
                $proprietaire->user->notify(new SubscriptionExpiredNotification('free_trial'));
            } catch (\Exception $e) {
    ...
    private function notifyTrialEndingSoon(): void
    {
        ...
        $ending = Proprietaire::where('subscription_status', 'free_trial')
